                    ...
                    return GridView.count(
                      ...
                      children: [
                        ...
                        _buildAdminCard(
                          ...
                          onTap: () => _showNotImplemented(context, 'Création d\'arène'),
                        ),
                        _buildAdminCard(
                          context,
                          icon: Icons.monitor,
                          title: 'Projection Live',
                          subtitle: 'Mode spectateur',
                          color: const Color(0xFF3B82F6),
                          onTap: () => _showNotImplemented(context, 'Mode projection'),
                        ),
                        _buildAdminCard(
                          context,
                          icon: Icons.people,
                          ...
                          color: const Color(0xFFF59E0B),
                          onTap: () => _showNotImplemented(context, 'Gestion utilisateurs'),
                        ),
                      ],
                    );
                  },
